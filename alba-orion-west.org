...
+ The Notes column is just to remind us 
| Dataset | imid | specid | Notes                |
|---------+------+--------+----------------------|
| 2006-02 |  323 |    324 | LL2 first epoch      |
| 2006-02 |  318 |    319 |                      |
| 2006-02 |  260 |    261 |                      |
| 2006-02 |  270 |    271 |                      |
| 2006-02 |  276 |    277 |                      |
...
| 2006-02 |  296 |    297 |                      |
| 2006-02 |  303 |    304 |                      |
| 2006-02 |  313 |    312 | Image follows spec!  |
|---------+------+--------+----------------------|
| 2007-01 |      |   2062 | LL2 second epoch     |
| 2007-01 |      |   2038 |                      |
| 2007-01 |      |   2042 |                      |
| 2007-01 |      |   2046 |                      |
| 2007-01 |      |   2050 |                      |
...
| 2007-01 |      |   2058 |                      |
|---------+------+--------+----------------------|
| 2007-01 |      |    055 | LL1 extreme N        |
| 2007-01 |      |    068 |                      |
| 2007-01 |      |    073 |                      |
|---------+------+--------+----------------------|
| 2010-01 |  078 |        | Vertical W of LL2    |
|---------+------+--------+----------------------|
| 2013-02 |  024 |        | Horizontal LL2       |
|---------+------+--------+----------------------|
| 2013-12 |  016 |        | Horizontal below LL2 |
|---------+------+--------+----------------------|
| 2015-02 |      |   0003 |                      |
| 2015-02 |      |   0013 |                      |
|---------+------+--------+----------------------|
...
+ These are each a dictionary of template formats, which is keyed by the date of observations (YYYY-MM)
+ There is a separate template for
  1. The original full spectrum file, which includes ha and nii
  ...
  2. The extracted Ha line
  3. The extracted [N II] line
  4. The image+slit exposure
     - I only use this for finding the ra, dec of the slit center
#+BEGIN_SRC python
  fullspecfile_template = {
      '2006-02': 'Work/SPM2005/pp{:03d}.fits',
  }

  hafile_template = {
      '2006-02': 'Work/SPM2007/Reduced/HH505/slits/SPMha/spec{:03d}-halpha.fits',
  }
  niifile_template = {
      '2006-02': 'Work/SPM2007/Reduced/HH505/slits/SPMnii/spec{:03d}-nii.fits',
  }

  imfile_template = {
      '2006-02': 'Dropbox/Papers/LL-Objects/feb2006/pp{:03d}-ardec.fits',
  }
#+END_SRC
...
#+begin_example
   ...
   cubeface: -1
     ...
     m_flag: 137
    m_naxis: 2
    m_crpix: 0x1005a00b0  (= crpix)
       m_pc: 0x1005ab020  (= pc)
    m_cdelt: 0x10059d2e0  (= cdelt)
    m_crval: 0x10056fdd0  (= crval)
    m_cunit: 0x1005b9f30  (= cunit)
    m_ctype: 0x1005c0210  (= ctype)
       m_pv: 0x0  (= pv)
       m_ps: 0x0  (= ps)
       m_cd: 0x1005b9fc0  (= cd)
    m_crota: 0x1005ba580  (= crota)

    m_colax: 0x1005b0630  (= colax)
    m_cname: 0x10058bda0  (= cname)
    m_crder: 0x1005bb3d0  (= crder)
    m_csyer: 0x1005abf70  (= csyer)
      m_tab: 0x0  (= tab)
      m_wtb: 0x0  (= wtb)
   ...
   lin.*
    ...
    pc[1][]:   0            6.6111e-05
      ...
      unity: 0
        err: 0x0
piximg[0][]:  -6.6111e-05   0         
piximg[1][]:   0            6.6111e-05
imgpix[0][]:  -15126       -0         
imgpix[1][]:   0            15126     
     m_flag: 0
    m_naxis: 0
   ...
   cel.*
     ...
     offset: 0
       phi0:  0.000000
     theta0: 90.000000
       ref:   83.744      -5.4471       180         -5.4471    
       prj: (see below)
     euler:   83.744       95.447       180         -0.094927     0.99548   
