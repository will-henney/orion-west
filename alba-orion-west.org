...
#+BEGIN_SRC sh :results silent
xpaset -p ds9 fits $PWD/Calibrated/2013-12-116-nii.fits
#+END_SRC
...
#+BEGIN_SRC python
  ...
  for fn in speclist:
      ...
      # Subtract off the local "continuum"
      waves = [wavrest-dwbg_out/2, wavrest-dwbg_in/2, wavrest-dw/2,
               wavrest+dw/2, wavrest+dwbg_in/2, wavrest+dwbg_out/2]
      iblue1, iblue2, i1, i2, ired1, ired2 = waves2pixels(waves, wspec)
