...
|-------+----------+---------+----------+----------+--------+--------+---------+--------+-------|
|   165 |      166 |      12 | 83.62409 | -5.44097 | 0.5248 | 90.496 |    2.05 |   0.73 | -0.50 |
|   169 |      170 |      13 | 83.62424 | -5.43831 | 0.5251 | 90.449 |    2.48 |   0.66 | -0.50 |
|   237 |      238 |      11 | 83.62752 | -5.43613 | 0.5249 | 90.421 |    1.25 |   0.93 | -0.00 |
|   232 |      233 |       9 | 83.62683 | -5.43216 | 0.5243 | 90.399 |    1.25 |   0.99 | -0.00 |
|   226 |      227 |      10 | 83.61872 | -5.42951 | 0.5252 | 90.462 |    1.28 |   1.09 | -0.00 |
|   149 |      150 |       4 | 83.63349 | -5.42399 | 0.5249 | 90.561 |    1.38 |   0.65 | -0.62 |
|   154 |      155 |       5 | 83.63366 | -5.42268 | 0.5247 | 90.579 |    1.51 |   0.68 | -0.62 |
|   159 |      160 |       9 | 83.63375 | -5.42026 | 0.5244 | 90.651 |    1.69 |   0.74 | -0.62 |
|    33 |       34 |      -4 | 83.62033 | -5.41655 | 0.5149 | 89.637 |    1.31 |   0.71 |  0.25 |
|    29 |       30 |      -4 | 83.61937 | -5.41543 | 0.5148 | 89.729 |    1.26 |   0.77 |  0.25 |
...
** Combine two the horizontal and vertical slits
#+BEGIN_SRC python
from astropy.io import fits
scale = 1.8
...
#+name: multi-smooth
#+BEGIN_SRC python :var label="sum" slits="vert" :results output
  import sys
...
#+BEGIN_SRC python :var labels=vel-channels slits="vert" :results output
  from astropy.io import fits
  import numpy as np
  nlist = [1, 2, 4, 8, 16]
  minweights = [0.5, 1.0, 2.0, 2.0, 2.0, 2.0]
...
** Application to the horiz+vert set 

#+call: multi-smooth[:results output](slits="slits, "label="sum")
...
#+call: multigrid-combine[:results output](labels=just-integrated, slits="slits")
