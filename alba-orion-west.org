...
python spec_augment_wcs.py Calibrated/BGsub/2013-02-165-ha.fits
#+END_SRC
...
#+BEGIN_SRC sh
xpaset -p ds9 fits $PWD/Calibrated/BGsub/2013-02-165-ha-vhel.fits
...
#+BEGIN_SRC sh :results silent
open -n -a SAOImage\ DS9 --args -title maps
#+END_SRC
