...
+ Output is an array of the profile, calculated from the nearest pixel
#+BEGIN_SRC python
...
The actual phootometric standard image we asre going to use.  This is from Massimo's ground-based program
#+BEGIN_SRC python
