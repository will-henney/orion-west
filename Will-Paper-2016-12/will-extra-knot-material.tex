...
\begin{figure*}
  \centering
  \includegraphics[width=\linewidth]{knot-and-core-nii-versus-ha-widths}
  \caption{FWHM line widths for the blue-shifted knots (left
    panel) and nebular core (right panel).}
  \label{fig:widths-ha-nii}
\end{figure*}

\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{knot-and-core-derived-temperatures}
  \caption{Histogram knot temperatures derived from comparison of 


    of blue-shifted knot [\nii] FWHM line widths
    according to velocity class (top three panels), compared with
    histogram of [\nii] FWHM line width the nebular line core at
    the knot positions (bottom panel).}
  \label{fig:histogram-widths}
